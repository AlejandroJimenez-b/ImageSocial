<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Surname (añadido por mi (no se genera al instalar la autenticacion)) -->
        <div>
            <x-input-label class="mt-2" for="surname" :value="__('Surname')" />
        ...
        <!-- Nick (añadido por mi (no se genera al instalar la autenticacion)) -->
        <div>
            <x-input-label class="mt-2" for="nick" :value="__('Nick')" />
